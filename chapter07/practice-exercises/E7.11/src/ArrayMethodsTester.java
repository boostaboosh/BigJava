...
public class ArrayMethodsTester
{
   ...
   public static void main(String[] args)
   {
      ...
      array.print();
      System.out.println("Expected: 10, 2, 3, 4, 5, 6, 7, 8, 9, 1");

      // b
      array.shiftRight();
      array.print();
      System.out.println("Expected: 1, 10, 2, 3, 4, 5, 6, 7, 8, 9");

      // c
      array.replaceAllEvenWithZero();
      array.print();
      System.out.println("Expected: 1, 0, 0, 3, 0, 5, 0, 7, 0, 9");

      // d
      array.replaceMiddleWithLargestNeighbour();
      array.print();
      System.out.println("Expected: 1, 1, 3, 0, 5, 0, 7, 0, 9, 9");

      // e
      array.removeMiddle();
      array.print();
      System.out.println("Expected: 1, 1, 3, 0, 7, 0, 9, 9");

      // f
      array.moveEvenToFront();
      array.print();
      System.out.println("Expected: 0, 0, 1, 1, 3, 7, 9, 9");
